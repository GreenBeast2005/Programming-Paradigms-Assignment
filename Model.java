...
public class Model
{
	...
	public void unMarshal(Json ob)
	{
		...
		{
			Sprite tempWall = new Wall(wallList.get(i));
        	sprites.add(tempWall);
			try {
				myWriter.write("this.sprites.push(new Wall(" + tempWall.getX() + ", " + tempWall.getY() + ", " + tempWall.getH() + ", " + tempWall.getW() + "))\n");
		   	} catch (IOException e) 
		   	{
			   	System.out.println("An error occurred.");
			   	e.printStackTrace();
		...
		{
			Sprite tempPellet = new Pellet(pelletList.get(i));
			sprites.add(tempPellet);
			try {
				myWriter.write("this.sprites.push(new Pellet(" + tempPellet.getX() + ", " + tempPellet.getY() + ", " + tempPellet.getH() + ", " + tempPellet.getW() + "))\n");
		   	} catch (IOException e) 
		   	{
			   	System.out.println("An error occurred.");
			   	e.printStackTrace();
		...
		{
			Sprite tempGhost = new Ghost(ghostList.get(i));
			sprites.add(tempGhost);
			try {
				myWriter.write("this.sprites.push(new Ghost(" + tempGhost.getX() + ", " + tempGhost.getY() + ", " + tempGhost.getH() + ", " + tempGhost.getW() + "))\n");
		   	} catch (IOException e) 
		   	{
			   	System.out.println("An error occurred.");
			   	e.printStackTrace();
		...
		{
			Sprite tempFruit = new Fruit(fruitList.get(i));
			sprites.add(tempFruit);
			try {
				myWriter.write("this.sprites.push(new Fruit(" + tempFruit.getX() + ", " + tempFruit.getY() + ", " + tempFruit.getH() + ", " + tempFruit.getW() + "))\n");
		   	} catch (IOException e) 
		   	{
			   	System.out.println("An error occurred.");
			   	e.printStackTrace();
